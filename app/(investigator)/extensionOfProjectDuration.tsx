...
const ProjectProposalForm = () => {
  ...
  return (
    <ScrollView style={styles.container}>
      <Text style={styles.heading}>EXTENSION OF PROJECT DURATION</Text>
...
<Text style={styles.label}>Justification for indicated items of time schedule. </Text>
      <TextInput
        style={[styles.input,{height:150}]}
        placeholder=""
        value={formData.justify}
        multiline
        onChangeText={(value) => handleInputChange("justify", value)}
      />

<Text style={styles.label}>Work expected to be done in next quarter </Text>
      <TextInput
        style={[styles.input,{height:150}]}
        placeholder=""
...
<Text style={styles.label}>Time Extension proposed and reasons for seeking the extension </Text>
      <TextInput
        style={[styles.input,{height:150}]}
        placeholder=""
        value={formData.timeextension}
        multiline
        onChangeText={(value) => handleInputChange("timeextension", value)}
      />
...
<Text style={styles.label}>The need or otherwise to take up further studies in the areas not covered under this study. </Text>
      <TextInput
        style={[styles.input,{height:150}]}
        placeholder=""
        value={formData.further}
        multiline
        onChangeText={(value) => handleInputChange("further", value)}
      />
...
<Text style={styles.label}>Conclusions and recommendations with quantification </Text>
      <TextInput
        ...
        multiline
        onChangeText={(value) => handleInputChange("conclusion", value)}
      />

<Text style={styles.label}>Total cost of the project and actual expenditure incurred</Text>
      <TextInput
        style={[styles.input,{height:150}]}
        placeholder=""
